        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Fast & Accurate Results</a></h4>
              <p>Get detailed reports in seconds with high accuracy.</p>
            </div>
          ...
          <div class="col-lg-4 d-flex" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <p>Simple and intuitive design – no technical skills needed.</p>
            </div>
          </div><!-- End Service Item -->
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <p>Ensure your essays, research papers, and assignments are 100% original before
                                    submission. Avoid accidental plagiarism with detailed similarity reports.</p>
            </div>
          </div><!-- End Service Item -->
